...
export const vocabulary: Category[] = [
  ...
  },
  {
    ...
    nameFr: "Animal Crossing",
    emoji: "🏝️",
    words: [
      { dutch: "eiland", french: "île", emoji: "🏝️" },
      { dutch: "buren", french: "voisins", emoji: "🏘️" },
      { dutch: "vlinder", french: "papillon", emoji: "🦋" },
      { dutch: "bloem", french: "fleur", emoji: "🌸" },
      { dutch: "fruit", french: "fruit", emoji: "🍑" },
      { dutch: "vis", french: "poisson", emoji: "🐟" },
      { dutch: "schelp", french: "coquillage", emoji: "🐚" },
      { dutch: "museum", french: "musée", emoji: "🏛️" },
      { dutch: "winkel", french: "magasin", emoji: "🏪" },
      { dutch: "fossiel", french: "fossile", emoji: "🦴" },
      { dutch: "bel", french: "clochette", emoji: "🔔" },
      { dutch: "boom", french: "arbre", emoji: "🌴" },
      { dutch: "onkruid", french: "mauvaise herbe", emoji: "🌿" },
      { dutch: "sterren", french: "étoiles", emoji: "⭐" },
      { dutch: "hengel", french: "canne à pêche", emoji: "🎣" },
    ],
  },
  {
    name: "Gabby's Poppenhuis",
    nameFr: "La Maison de Gabby",
    emoji: "🐱",
    words: [
      { dutch: "kat", french: "chat", emoji: "🐱" },
      { dutch: "poppenhuis", french: "maison de poupée", emoji: "🏠" },
      { dutch: "knutselen", french: "bricoler", emoji: "✂️" },
      { dutch: "feest", french: "fête", emoji: "🎉" },
      { dutch: "doos", french: "boîte", emoji: "📦" },
      { dutch: "strikje", french: "nœud", emoji: "🎀" },
      { dutch: "glitter", french: "paillettes", emoji: "✨" },
      { dutch: "muziek", french: "musique", emoji: "🎵" },
      { dutch: "taart", french: "gâteau", emoji: "🎂" },
      { dutch: "verf", french: "peinture", emoji: "🖌️" },
      { dutch: "kamer", french: "chambre", emoji: "🚪" },
      { dutch: "vriend", french: "ami", emoji: "🤗" },
      { dutch: "boot", french: "bateau", emoji: "⛵" },
      { dutch: "tuin", french: "jardin", emoji: "🌷" },
      { dutch: "fee", french: "fée", emoji: "🧚" },
    ],
  },
  {
    name: "School",
    ...
    emoji: "🏫",
    words: [
      { dutch: "boek", french: "livre", emoji: "📖" },
      { dutch: "pen", french: "stylo", emoji: "🖊️" },
      { dutch: "potlood", french: "crayon", emoji: "✏️" },
      { dutch: "tas", french: "sac", emoji: "🎒" },
      { dutch: "leraar", french: "professeur", emoji: "👨‍🏫" },
      { dutch: "klas", french: "classe", emoji: "🏫" },
      { dutch: "bord", french: "tableau", emoji: "📋" },
      { dutch: "rekenenen", french: "calculer", emoji: "🧮" },
      { dutch: "speelplaats", french: "cour de récréation", emoji: "🛝" },
      { dutch: "huiswerk", french: "devoirs", emoji: "📝" },
      { dutch: "gum", french: "gomme", emoji: "🧽" },
      { dutch: "schaar", french: "ciseaux", emoji: "✂️" },
      { dutch: "liniaal", french: "règle", emoji: "📏" },
      { dutch: "vriend", french: "ami", emoji: "🤝" },
      { dutch: "pauze", french: "récréation", emoji: "⏸️" },
    ],
  },
  {
    name: "Muziek",
    ...
    emoji: "🎵",
    words: [
      { dutch: "lied", french: "chanson", emoji: "🎶" },
      { dutch: "gitaar", french: "guitare", emoji: "🎸" },
      { dutch: "piano", french: "piano", emoji: "🎹" },
      { dutch: "drums", french: "batterie", emoji: "🥁" },
      { dutch: "zingen", french: "chanter", emoji: "🎤" },
      { dutch: "dansen", french: "danser", emoji: "💃" },
      { dutch: "trompet", french: "trompette", emoji: "🎺" },
      { dutch: "viool", french: "violon", emoji: "🎻" },
      { dutch: "fluit", french: "flûte", emoji: "🪈" },
      { dutch: "concert", french: "concert", emoji: "🎪" },
      { dutch: "muzikant", french: "musicien", emoji: "🧑‍🎤" },
      { dutch: "ritme", french: "rythme", emoji: "🔊" },
      { dutch: "koptelefoon", french: "casque", emoji: "🎧" },
      { dutch: "noot", french: "note", emoji: "🎵" },
      { dutch: "band", french: "groupe", emoji: "🎸" },
    ],
  },
  {
    name: "België",
    ...
    emoji: "🇧🇪",
    words: [
      { dutch: "wafel", french: "gaufre", emoji: "🧇" },
      { dutch: "friet", french: "frites", emoji: "🍟" },
      { dutch: "chocolade", french: "chocolat", emoji: "🍫" },
      { dutch: "bier", french: "bière", emoji: "🍺" },
      { dutch: "hoofdstad", french: "capitale", emoji: "🏛️" },
      { dutch: "koning", french: "roi", emoji: "👑" },
      { dutch: "koningin", french: "reine", emoji: "👸" },
      { dutch: "strand", french: "plage", emoji: "🏖️" },
      { dutch: "kasteel", french: "château", emoji: "🏰" },
      { dutch: "voetbal", french: "football", emoji: "⚽" },
      { dutch: "kers", french: "cerise", emoji: "🍒" },
      { dutch: "markt", french: "marché", emoji: "🛒" },
      { dutch: "trein", french: "train", emoji: "🚆" },
      { dutch: "regen", french: "pluie", emoji: "🌧️" },
      { dutch: "manneken pis", french: "Manneken-Pis", emoji: "⛲" },
    ],
  },
  {
    name: "Werkwoorden",
